...
protected	List<TouchableControl>	touchables;
protected	List<Rect>				maskAreas;	
...
private void Awake()
	...
	if (this.disableWhenNoTouchScreen && 
		((SystemInfo.deviceType == DeviceType.Handheld) && !Input.multiTouchEnabled))
		{
